    ...
    <div className="flex flex-col p-xl">
      ...
      <div className="flex flex-col gap-md border-t pt-xl mt-xl">
        ...
        <div className="leading-10">
          ...
          <p>좀 더 심화된 내용으로 넘어가면, IP 주소는 IPv4와 IPv6 두 가지 버전이 있습니다.</p>
          <ul className="flex flex-col list-disc pl-md">
            <li>
              ...
              개의 고유 주소를 제공하는데, 인터넷 사용자 수의 급격한 증가로 인해 이 주소들이 점점
              부족해지고 있습니다.
            </li>
            <li>
              ...
              형태입니다. IPv6는 IPv4에 비해 거의 무한에 가까운 주소를 제공하므로, IP 주소 부족
